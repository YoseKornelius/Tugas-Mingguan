...
public class CheckLocation extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder( CheckLocation.this )
                .setMessage( message )
